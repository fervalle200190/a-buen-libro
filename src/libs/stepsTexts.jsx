const steps = [
        {
            title: "El libro respeta la inteligencia de sus lectores",
        ...
        {
            title: "El libro funciona como una unidad armoniosa y atractiva",
        ...
        {
            title: "El libro está escrito excelentemente",
        ...
        {
            title: "El libro es relevante e iluminador",
            text: "Los temas y conflictos tratados son universales a la experiencia humana. Los personajes son memorables, multidimensionales, y dinámicos. Se evitan los estereotipos y clichés. El tratamiento de los temas ilumina la propia vida de los lectores y amplía su comprensión del mundo. Cuando es pertinente, el libro trata también temas difíciles de forma responsable y profunda. La lectura del libro entusiasma a los lectores a hacerse preguntas fundamentales, a discutir temas de alto interés, y/o a embarcarse en la ejecución de proyectos nobles. Cuando los temas son oscuros, el libro también provee cierta luz de esperanza que da un respiro a sus lectores."
        },
        {
            title: "El libro es legible y está bien encuadernado y organizado",
            text: "Todo en el diseño (tipografía, formato, composición, papel, espacio entre líneas, márgenes, contraste entre colores, etc.) y en la encuadernación contribuye a que el libro sea fácil de leer y que perdure en el tiempo, a pesar del uso de niños y jóvenes."
        }
